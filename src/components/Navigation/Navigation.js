    ...
    return(
        <div id='navigation-bg'>
            <nav className='bb bt mw8 mb4 center flex-wrap'>
                ...
                <p className='link pointer underline bg-animate hover-bg-black-10 pa1 pa2-m pa3-l ma1 b f7 f6-m f5-l'><a href='https://shoppy.gg/product/hfRLCkS' className='black' target='_blank' rel="noopener noreferrer">Where to buy</a></p>
