	...
	<div>
		<div>
			<nav className="bb bt mw8 center mt4 mb4">
				...
				<p onKeyPress={null} onClick={() => onRouteChange('contactus')} className="link pointer underline bg-animate hover-bg-black-10 pa2-m pa3-l ma1 b f7 f6-m f5-l">Contact Us</p>
				<p onKeyPress={null} onClick={() => onRouteChange('termsandconditions')} className="link pointer underline bg-animate hover-bg-black-10 pa2-m pa3-l ma1 b f7 f6-m f5-l">Terms & Conditions</p>
				...
				<p onKeyPress={null} onClick={() => onRouteChange('blog')} className="link pointer underline bg-animate hover-bg-black-10 pa2-m pa3-l ma1 b f7 f6-m f5-l">Blog</p>
			</nav>
		</div>
